defmodule Tenant.Repo.Migrations.EnableRlsForCategories do
  ...
  def change do
    execute "ALTER TABLE categories ENABLE ROW LEVEL SECURITY;", "ALTER TABLE categories DISABLE ROW LEVEL SECURITY;"
    execute "ALTER TABLE categories FORCE ROW LEVEL SECURITY;", "ALTER TABLE categories NO FORCE ROW LEVEL SECURITY;"
    execute """
